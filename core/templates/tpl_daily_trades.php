...
$trades = $dailyTrade->getDailyTrades();
...
<div class="container mt-3">
    <div class="center">
        <h1 style="text-align: center;">Add Daily Trades</h1>
    </div>
    <form name="add-backtest-trade"
          id="add-backtest-trade"
          action="<?php echo $urlInterface->getAddDailyTradeUrl(); ?>"
            ...
            <div class="col-sm col-lg-2">
                ...
                <select class="form-select" id="symbol" name="symbol" aria-label="Select Symbol" required>
                    <?php foreach ($symbols as $symbol) { ?>
                        <option value="<?php echo $symbol['symbol']; ?>" <?php if ($symbol['symbol'] == "RELIANCE") {
                            echo "selected";
                        } ?>>
...
if (count($trades) > 0) {
    ...
    <div class="container-fluid">
        <table id="daily_tradebook" class="table table-bordered" style="border-collapse: collapse">
            <thead>
            <?php
